...
type PayoutCandidateValidation func(candidate *PayoutCandidate, configuration *configuration.RuntimeConfiguration, overrides *configuration.RuntimeDelegatorOverride, ctx *Context)
...
func (validationContext *PayoutValidationContext) Validate(validators ...PayoutCandidateValidator) *PayoutValidationContext {
	...
	for _, validator := range validators {
		...
		log.Tracef("payout to %s validation result: %b", validationContext.Payout.Recipient, validationContext.Payout.IsInvalid)
...
// validations
func ValidateRecipient(candidate *PayoutCandidate, _ *configuration.RuntimeConfiguration, _ *configuration.RuntimeDelegatorOverride, _ *Context) {
...
func ValidateMinimumBalance(candidate *PayoutCandidate, configuration *configuration.RuntimeConfiguration, overrides *configuration.RuntimeDelegatorOverride, _ *Context) {
...
func ValidateEmptied(candidate *PayoutCandidate, configuration *configuration.RuntimeConfiguration, _ *configuration.RuntimeDelegatorOverride, _ *Context) {
...
func ValidateIsIgnored(candidate *PayoutCandidate, configuration *configuration.RuntimeConfiguration, _ *configuration.RuntimeDelegatorOverride, _ *Context) {
...
func ValidateIgnoreKt(candidate *PayoutCandidate, configuration *configuration.RuntimeConfiguration, _ *configuration.RuntimeDelegatorOverride, _ *Context) {
...
func ValidateRecipientNotBaker(candidate *PayoutCandidate, configuration *configuration.RuntimeConfiguration, _ *configuration.RuntimeDelegatorOverride, ctx *Context) {
